  ...
  <section class="terms">
    ...
    <div class="page_wrapper">
      ...
      <section class="about_us_section">
        ...
        <div class="container">
          <div class="row abt_text">
            <div class="col-md-12">
              <div class="section_title textStyle">
                <span class="title_badge">Terms & Conditions</span>
                <h2>
              ...
              <div class="terms-conditions-info">
                ...
                <p>
                  ...
                  NY.<br />
                  We operate the website https://virtualrealitycreators.com/supportSnap-web/ (the
                  "Site"), the mobile application SupportSnap (the "App"), as well as any other
                  ...
                  personally or on behalf of an entity ("you"), and SupportSnap, concerning your
                  ...
                  DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM
                ...
                <p>
                  ...
                  notifying you by as stated in the email message. By continuing to use the Services
                  after the effective date of any changes, you agree to be bound by the modified
                  terms.
                </p>
                <p>
                ...
                <div class="termsblock">
                  <ol>
                    <li @click.prevent="toppad('os')"><a>OUR SERVICES</a></li>
                    <li @click.prevent="toppad('ipr')"><a>INTELLECTUAL PROPERTY RIGHTS</a></li>
                    <li @click.prevent="toppad('ur')"><a>USER REPRESENTATIONS</a></li>
                    <li @click.prevent="toppad('urg')"><a>USER REGISTRATION</a></li>
                    <li @click.prevent="toppad('pap')"><a>PURCHASES AND PAYMENT</a></li>
                    <li @click.prevent="toppad('cn')"><a>CANCELLATION</a></li>
                    <li @click.prevent="toppad('s')"><a>SOFTWARE</a></li>
                    <li @click.prevent="toppad('pa')"><a>PROHIBITED ACTIVITIES</a></li>
                    <li @click.prevent="toppad('ugc')"><a>USER GENERATED CONTRIBUTIONS</a></li>
                    <li @click.prevent="toppad('cl')"><a>CONTRIBUTION LICENSE</a></li>
                    <li @click.prevent="toppad('mal')"><a>MOBILE APPLICATION LICENSE</a></li>
                    <li @click.prevent="toppad('tpwc')"><a>THIRD-PARTY WEBSITES AND CONTENT</a></li>
                    <li @click.prevent="toppad('sm')"><a>SERVICES MANAGEMENT</a></li>
                    <li @click.prevent="toppad('pp')"><a>PRIVACY POLICY</a></li>
                    <li @click.prevent="toppad('tat')"><a>TERM AND TERMINATION</a></li>
                    <li @click.prevent="toppad('mai')"><a>MODIFICATIONS AND INTERRUPTIONS</a></li>
                    <li @click.prevent="toppad('gl')"><a>GOVERNING LAW</a></li>
                    <li @click.prevent="toppad('dr')"><a>DISPUTE RESOLUTION</a></li>
                    <li @click.prevent="toppad('c')"><a>CORRECTIONS</a></li>
                    <li @click.prevent="toppad('d')"><a>DISCLAIMER</a></li>
                    <li @click.prevent="toppad('lol')"><a>LIMITATIONS OF LIABILITY</a></li>
                    <li @click.prevent="toppad('i')"><a>INDEMNIFICATION</a></li>
                    <li @click.prevent="toppad('ud')"><a>USER DATA</a></li>
                    <li @click.prevent="toppad('ectas')">
                      <a>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
                    </li>
                    <li @click.prevent="toppad('cu')"><a>CONTACT US</a></li>
                  </ol>
                </div>
                <div class="termsbox" id="os">
                ...
                <div class="termsbox" id="ipr">
                  ...
                  <ul>
                    <li>
                      ...
                      the Services any Submission nor post any Contribution that is illegal,
                ...
                <div class="termsbox" id="ur">
                  ...
                  <p>
                    ...
                    agree to comply with these Legal Terms; (4) you are not under the age of 13; (5)
                    you are not a minor in the jurisdiction in which you reside, or if a minor, you
                    have received parental permission to use the Services; (6) you will not access
                    ...
                    unauthorized purpose; and (8) your use of the Services will not violate any
                ...
                <div class="termsbox" id="s">
                  ...
                  <p>
                    ...
                    with our services and in accordance with these Legal Terms. Any software and any
                ...
                <div class="termsbox" id="mal">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      or derivative work from the App;
                    </li>
                    <li>
                      (3) violate any applicable laws, rules, or regulations in connection with your
                    ...
                    <li>
                      (5) use the App for any revenue-generating endeavor, commercial enterprise, or
                      other purpose for which it is not designed or intended;
                    </li>
                    <li>
                      (6) make the App available over network or other environment permitting access
                      or use by multiple devices or users at the same time;
                    </li>
                    <li>
                      (7) use the App for creating a product, service, or software that is, directly
                  ...
                  <ul>
                    <li>
                      (1) the license granted to you for our App is limited to a non-transferable
                    ...
                    <li>
                      ...
                      is subject to a US government embargo, or that has been designated by the US
                    ...
                    <li>
                      (5) you must comply with applicable third- party terms of agreement when using
                      the App, e.g., if you have a VoIP application, then you must not be in
                ...
                <div class="termsbox" id="pp">
                  <h3>PRIVACY POLICY</h3>
                  <p>
                    We care about data privacy and security. Please review our Privacy Policy:

                    <a href="https://SupportSnap.staginganideos.com/privacy_policy"
                      >https://SupportSnap.staginganideos.com/privacy_policy</a
                    >.
                  </p>
                  <p>
                ...
                <div class="termsbox" id="mai">
                  ...
                  <p>
                    ...
                    or discontinuance of the Services. We cannot guarantee the Services will be
                ...
                <div class="termsbox" id="dr">
                  ...
                  <p>
                    ...
                    (&quot;AAA Consumer Rules&quot;), both of which are available at the American
                    ...
                    law, and any award may be challenged if the arbitrator fails to do so. Except
                    where otherwise required by the applicable AAA rules or applicable law, the
                    arbitration will take place in Suffolk County, New York. Except as otherwise
                  ...
                  <p>
                    ...
                    in Suffolk County, New York, and the Parties hereby consent to, and waive all
                    ...
                    Legal Terms. If this provision is found to be illegal or unenforceable, then
                  ...
                  <p>
                    ...
                    public or any other persons. Exceptions to Informal Negotiations and
                    Arbitration.
                  </p>
                  <p>
                ...
                <div class="termsbox" id="d">
                  <h3>DISCLAIMER</h3>
                  <p>
                    THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT
                    PARTICULAR YOUR USE OF THE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST
                    ...
                    LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PURPOSE,
                    AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE
                    ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      FROM YOUR ACCESS TO AND USE OF THE SERVICES,
                    </li>
                    <li>
                ...
                <div class="termsbox" id="lol">
                  ...
                  <p>
                    ...
                    OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $0.00 USD. CERTAIN US STATE LAWS AND
                ...
                <div class="termsbox" id="i">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      at your expense, with our defense of such efforts to notify you of any such
                      claim, action, upon becoming aware of it.
                    </li>
                  </ul>
                </div>
                <div class="termsbox" id="ud">
                  <h3>USER DATA</h3>
                  <p>
                    We will maintain certain data that you or proceeding claims. We will use
                    reasonable which is subject to this indemnification transmit to the Services for
...
const toppad = (id) => {
  ...
  if (targetElement) {
    ...
    setTimeout(() => {
      ...
      // targetElement.classList.remove('padded-section')
      isRolled.value = true
...
const removeHighlight = () => {
  ...
  if (element) {
    element.classList.remove('padded-section')
